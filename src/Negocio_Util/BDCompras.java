...
//    private static  String url = "jdbc:mysql://localhost:3306/"+bd;
    //--== SANDBOX ==--//
//    private static String bd = "compras";
//    private static String login = "root";
//    private static String password = "Soporte";
...
//    private static JDBCMiddler jdbc;
    ...
    public static void asignarip1() {
        archivos a = new archivos();
//        String ipExt = a.leerTxt("C:\\Sistema\\config\\ip.txt");
        String ipExt = a.leerTxt("C:\\Sistema\\config\\ipBodega.txt");
        String dbExt = a.leerTxt("C:\\Sistema\\config\\dbc.txt");
//        System.out.println("ip bd"+ipExt);
        ip = ipExt;
        bd = dbExt;
        login = "root";
        password = "Soporte";
